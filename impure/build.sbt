...
lazy val library =
  new {
    ...
    val refinedEval       = "eu.timepit"             %% "refined-eval"         % Version.refined
    val refinedJsonPath   = "eu.timepit"             %% "refined-jsonpath"     % Version.refined
    val refinedSlick      = "be.venneborg"           %% "slick-refined"     % Version.refined
